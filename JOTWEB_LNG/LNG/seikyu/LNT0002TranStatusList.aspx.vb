...
#Region "出力"
    ...
    Protected Sub ToriSPRATEDataGet(ByVal SQLcon As MySqlConnection)
        ...
        SQLStr.Append("     ,coalesce(LNS6.VALUE2, '')                              AS UNIT  		        ")
        SQLStr.Append("     ,(SELECT VALUE1                                                                 ")
        SQLStr.Append("         FROM COM.LNS0006_FIXVALUE                                                   ")
        SQLStr.Append("        WHERE CAMPCODE = @CAMPCODE                                                   ")
        SQLStr.Append("          AND CLASS    = 'TAXRATE'                                                   ")
        ...
        SQLStr.Append(" LEFT JOIN COM.LNS0006_FIXVALUE LNS6                                                 ")
        SQLStr.Append("   ON LNS6.CAMPCODE = @CAMPCODE                                                      ")
        SQLStr.Append("  AND LNS6.CLASS    = 'CALCUNITDROP'                                                 ")
        SQLStr.Append("  AND LNS6.VALUE1   = LNM14.CALCUNIT                                                 ")
        SQLStr.Append("  AND CURDATE() BETWEEN LNS6.STYMD AND LNS6.ENDYMD                                   ")
        SQLStr.Append("  AND LNS6.DELFLG  = @DELFLG                                                         ")
        SQLStr.Append(" WHERE                                                                               ")
