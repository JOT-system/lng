<%@ Page Title="LNT0023L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNT0023PayeeLinkList.aspx.vb" Inherits="JOTWEB_LNG.LNT0023PayeeLinkList" %>
...
<asp:Content ID="LNT0023LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNT0023L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNT0023L.js")%>'></script>
...
<asp:Content ID="LNT0023L" ContentPlaceHolderID="contents1" runat="server">
        ...
        <div style="display:none;">
            ...
            <input id="WF_lineCntLIST" runat="server" value="" type="text" />
            <input id="WF_CHKLINKLIST" runat="server" value="" type="text" />
            <!-- GridView 入力状態格納 -->
        </div>
