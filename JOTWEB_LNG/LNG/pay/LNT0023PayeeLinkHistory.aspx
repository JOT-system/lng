<%@ Page Title="LNT0023H" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNT0023PayeeLinkHistory.aspx.vb" Inherits="JOTWEB_LNG.LNT0023PayeeLinkHistory" %>
...
<asp:Content ID="LNT0023HH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNT0023H.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNT0023H.js")%>'></script>
...
<asp:Content ID="LNT0023H" ContentPlaceHolderID="contents1" runat="server">
