...
Public Class LNT0004WRKINC
    Inherits UserControl

    Public Const MAPIDS As String = "LNT0004S"       'MAPID(条件)
    Public Const MAPIDL As String = "LNT0004L"       'MAPID(実行)
    Public Const MAPIDC As String = "LNT0004C"       'MAPID(更新)
    ...
    Public Shared Function GetNewDisplayFlags() As List(Of DisplayFlag)
        ...
        '   retVal.Add(New DisplayFlag(True, "タンク", "BIGCTN08", 8, "70"))
        '   retVal.Add(New DisplayFlag(True, "ホッパ", "BIGCTN09", 9, "75"))
        '   retVal.Add(New DisplayFlag(True, "海上", "BIGCTN10", 10, "80"))
        Return retVal
    End Function
