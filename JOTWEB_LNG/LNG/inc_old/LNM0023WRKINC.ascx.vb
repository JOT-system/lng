...
Public Class LNM0023WRKINC
    Inherits UserControl

    Public Const MAPIDS As String = "LNM0023S"       'MAPID(検索)
    Public Const MAPIDL As String = "LNM0023L"       'MAPID(一覧)
    Public Const MAPIDD As String = "LNM0023D"       'MAPID(更新)
    'タイトル区分
