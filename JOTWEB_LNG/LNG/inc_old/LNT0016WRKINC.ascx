<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="LNT0016WRKINC.ascx.vb" Inherits="JOTWEB_LNG.LNT0016WRKINC" %>
...
<%--    <asp:TextBox ID="WF_SEL_REPORT" runat="server"></asp:TextBox>                   <!-- 帳票名 -->
    <asp:TextBox ID="WF_SEL_ORG" runat="server"></asp:TextBox>                      <!-- 対象支店 -->
    <asp:TextBox ID="WF_SEL_STYMD" runat="server"></asp:TextBox>                    <!-- 年月日(開始) -->
    <asp:TextBox ID="WF_SEL_ENDYMD" runat="server"></asp:TextBox>                   <!-- 年月日(終了) -->
