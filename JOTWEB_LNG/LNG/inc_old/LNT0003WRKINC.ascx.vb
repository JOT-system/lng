...
Public Class LNT0003WRKINC
    Inherits UserControl

    Public Const MAPIDS As String = "LNT0003S"       'MAPID(条件)
    Public Const MAPIDL As String = "LNT0003L"       'MAPID(実行)
    Public Const MAPIDC As String = "LNT0003C"       'MAPID(更新)
