...
Partial Public Class LNT0018PaymentLedgerReportOutput
    
    '''<summary>
    '''WF_ORGCODE_ALL コントロール。
    '''</summary>
    '''<remarks>
    '''自動生成されたフィールド。
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents WF_ORGCODE_ALL As Global.JOTWEB_LNG.GRC0001TILESELECTORWRKINC
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents WF_ORGCODE As Global.JOTWEB_LNG.GRC0001TILESELECTORWRKINC
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents work As Global.JOTWEB_LNG.LNT0018WRKINC
