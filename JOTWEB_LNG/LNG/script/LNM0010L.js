...
window.onload = function () {
    ...
    //表示判断キー
    const VisibleKeyAdminOrgCode = document.getElementById('VisibleKeyAdminOrgCode').value;
    const VisibleKeyTohokuOrgCode = document.getElementById('VisibleKeyTohokuOrgCode').value;

    //情シス、高圧ガス以外の場合
    if (VisibleKeyAdminOrgCode == "") {
        //変更履歴を非表示にする
