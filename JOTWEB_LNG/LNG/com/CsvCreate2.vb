Public Class CsvCreate2 : Implements System.IDisposable
    ''' <summary>
    ''' 雛形ファイルパス
    ''' </summary>
    ...
    Public Sub New(ByVal csvDataClass As DataTable,
                   ...
                   Optional ByVal I_DelFile As String = "0",
                   Optional ByVal I_DeleteKey As String = Nothing)
        ...
        If Not String.IsNullOrEmpty(I_FolderPath) Then
            If Not String.IsNullOrEmpty(I_FileName) Then
                Me.UploadFilePath = IO.Path.Combine(I_FolderPath, I_FileName)
            Else
        ...
        If I_DelFile = "1" Then
            ...
            Dim deleteFilePrefix As String = I_DeleteKey
            For Each targetFile In targetFiles
                Dim fileName As String = IO.Path.GetFileName(targetFile)
                '今日の日付が先頭のファイル名の場合は残す
                If fileName.StartsWith(deleteFilePrefix) Then
                    Try
