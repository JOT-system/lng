Public Class CsvCreate : Implements System.IDisposable
    ...
    ''' <param name="I_PlacedFileName">格納先フォルダ用ファイル名"</param>
    Public Sub New(csvDataClass As DataTable,
                   ...
                   Optional ByVal I_DelFile As String = "1",
                   Optional ByVal I_PlacedFileName As String = Nothing)
        ...
        If Not String.IsNullOrEmpty(I_FolderPath) Then
            If Not String.IsNullOrEmpty(I_PlacedFileName) Then
                Me.UploadFilePath = IO.Path.Combine(I_FolderPath, I_PlacedFileName)
            Else
    ...
    Public Function ConvertDataTableToCsv(writeHeader As Boolean,
        ...
        Try
            ...
            '    'wc.DownloadFile(Me.UploadTmpFilePath, Me.UploadFilePath)
            '    'wc.Dispose()
            'End If
