...
Public Class EntrySeisanFData
    ...
    Public Shared Function SelectRessnfPage(sqlCon As MySqlConnection, sqlTran As MySqlTransaction,
        ...
        'ユーザマスタ(申請者)
        SQLBldr.AppendLine("    LEFT JOIN com.LNS0002_USER A11")
        ...
        'ユーザマスタ(承認者)
        SQLBldr.AppendLine("    LEFT JOIN com.LNS0002_USER A12")
        ...
        '組織マスタ（JOT発組織）
        SQLBldr.AppendLine(" LEFT JOIN")
        SQLBldr.AppendLine("     com.LNS0019_ORG A14")
        ...
        '組織マスタ（JOT着組織）
        SQLBldr.AppendLine(" LEFT JOIN")
        SQLBldr.AppendLine("     com.LNS0019_ORG A15")
        ...
        'ユーザマスタ(承認者)
        SQLBldr.AppendLine("    LEFT JOIN com.LNS0002_USER A18")
        ...
        '組織マスタ（請求項目 計上店）
        SQLBldr.AppendLine(" LEFT JOIN")
        SQLBldr.AppendLine("     com.LNS0019_ORG A21")
        ...
        '組織マスタ（請求項目 提出部店）
        SQLBldr.AppendLine(" LEFT JOIN")
        SQLBldr.AppendLine("     com.LNS0019_ORG A22")
        ...
        '組織マスタ（支払項目 計上店）
        SQLBldr.AppendLine(" LEFT JOIN")
        SQLBldr.AppendLine("     com.LNS0019_ORG A23")
        ...
        '組織マスタ（支払項目 提出部店）
        SQLBldr.AppendLine(" LEFT JOIN")
        SQLBldr.AppendLine("     com.LNS0019_ORG A24")
        ...
        '組織マスタ（JOT発組織）
        SQLBldr.AppendLine(" LEFT JOIN")
        SQLBldr.AppendLine("     com.LNS0019_ORG B14")
        ...
        '組織マスタ（JOT着組織）
        SQLBldr.AppendLine(" LEFT JOIN")
        SQLBldr.AppendLine("     com.LNS0019_ORG B15")
        ...
        'ユーザマスタ(登録ユーザ)
        SQLBldr.AppendLine("    LEFT JOIN com.LNS0002_USER INITUSERORG")
        ...
        '組織マスタ（請求項目 計上店）
        SQLBldr.AppendLine(" LEFT JOIN")
        SQLBldr.AppendLine("     com.LNS0019_ORG B20")
        ...
        '組織マスタ（請求項目 提出部店）
        SQLBldr.AppendLine(" LEFT JOIN")
        SQLBldr.AppendLine("     com.LNS0019_ORG B21")
        ...
        '組織マスタ（支払項目 計上店）
        SQLBldr.AppendLine(" LEFT JOIN")
        SQLBldr.AppendLine("     com.LNS0019_ORG B22")
        ...
        '組織マスタ（支払項目 提出部店）
        SQLBldr.AppendLine(" LEFT JOIN")
        SQLBldr.AppendLine("     com.LNS0019_ORG B23")
