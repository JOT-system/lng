<%@ Page Title="LNM0003S" Language="vb" AutoEventWireup="false" CodeBehind="LNM0003RekejmSearch.aspx.vb" Inherits="JOTWEB_LNG.LNM0003RekejmSearch" %>
...
<asp:Content id="LNM0003SH" contentplaceholderid="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0003S.css")%>' rel="stylesheet" type="text/css" />
</asp:Content>

<asp:Content ID="LNM0003S" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　searchbox -->
