<%@ Page Title="LNM0015H" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0015ResrtmHistory.aspx.vb" Inherits="JOTWEB_LNG.LNM0015ResrtmHistory" %>
...
<asp:Content ID="LNM0015HH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0015H.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0015H.js")%>'></script>
...
<asp:Content ID="LNM0015H" ContentPlaceHolderID="contents1" runat="server">
