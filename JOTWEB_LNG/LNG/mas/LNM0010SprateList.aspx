<%@ Page Title="LNM0010L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0010SprateList.aspx.vb" Inherits="JOTWEB_LNG.LNM0010SprateList" %>
...
<asp:Content ID="LNM0010LH" ContentPlaceHolderID="head" runat="server">
    <meta charset="UTF-8"/>
    ...
    <link href='<%=ResolveUrl("~/LNG/css/LNM0010L.css")%>' rel="stylesheet" type="text/css" />
    <script src="https://cdn.jsdelivr.net/npm/flatpickr@latest/dist/plugins/monthSelect/index.js"></script>
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0010L.js")%>'></script>
...
<asp:Content ID="LNM0010L" ContentPlaceHolderID="contents1" runat="server">
            ...
            <div class="w-100 contents">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">特別料金マスタ</li>
                    </ol>
                </nav>
                <div id="contentsInner" class="border bg-white px-3 py-3 overflow-hidden contents-inner">
                    <h2 class="w-100 fs-5 fw-bold contents-title">特別料金マスタ</h2>
                        <div class="Operation">
                            <div class="actionButtonBox">
                                ...
                                <div class="rightSide">
                                    ...
                                    <%--<input type="button" id="WF_ButtonKGUPD"   class="btn-sticky btn-action" value="更新"     onclick="ButtonClick('WF_ButtonKGUPD');" />--%>
                                    <asp:button ID="WF_ButtonKGUPD" CssClass="btn-sticky btn-action" text="更新" runat="server"  OnClientClick="ButtonClick('WF_ButtonKGUPD');" Visible="false" />
    ...
    <div style="display:none;">
        <!-- 表示制御項目 -->
        <input id="VisibleKeyAdminOrgCode" runat="server" value="" type="text" />
        <input id="VisibleKeyIshikariOrgCode" runat="server" value="" type="text" />
        <input id="VisibleKeyHachinoheOrgCode" runat="server" value="" type="text" />
        <input id="VisibleKeyTohokuOrgCode" runat="server" value="" type="text" />
        <input id="VisibleKeyMizushimaOrgCode" runat="server" value="" type="text" />
