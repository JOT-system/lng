...
''' </summary>
''' <remarks></remarks>
Public Class LNM0013RektrmSearch
    Inherits Page
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = LNM0013WRKINC.MAPIDS
    ...
    Protected Sub WW_MAPValueSet()
        ...
        ElseIf Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.LNM0013L Then
            ' 実行画面からの遷移
        ...
        ' 大分類コード・中分類コードを入力するテキストボックスは数値(0～9)のみ可能とする。
        Me.TxtBigCTNCD.Attributes("onkeyPress") = "CheckNum()"
        Me.TxtMiddleCTNCD.Attributes("onkeyPress") = "CheckNum()"

        '○ RightBox情報設定
        rightview.MAPIDS = LNM0013WRKINC.MAPIDS
        rightview.MAPID = LNM0013WRKINC.MAPIDL
    ...
    Protected Sub WF_ButtonSEARCH_Click()
        ...
        work.WF_SEL_MIDDLECTNCD.Text = TxtMiddleCTNCD.Text        '小分類コード
        ' 論理削除フラグ
    ...
    Protected Sub WF_ButtonEND_Click()
        ...
        '○ メニュー画面遷移
        Master.TransitionPrevPage(, LNM0013WRKINC.TITLEKBNS)
    ...
    Protected Sub WF_FiledChange()
        ...
        Select Case WF_FIELD.Value
            Case "TxtBigCTNCD"       '大分類コード
                CODENAME_get("BIGCTNCD", TxtBigCTNCD.Text, LblBigCTNCDName.Text, WW_RtnSW)  '大分類コード
                TxtBigCTNCD.Focus()
            Case "TxtMiddleCTNCD"    '中分類コード
                CODENAME_get("MIDDLECTNCD", TxtMiddleCTNCD.Text, LblMiddleCTNCDName.Text, WW_RtnSW)  '中分類コード
                TxtMiddleCTNCD.Focus()
        End Select
    ...
    Protected Sub WF_ButtonCan_Click()
        ...
        '○ フォーカスセット
        Select Case WF_FIELD.Value
            Case "TxtBigCTNCD"               'コンテナ記号
                TxtBigCTNCD.Focus()
            Case "TxtMiddleCTNCD"               'コンテナ番号
                TxtMiddleCTNCD.Focus()
        End Select
