<%@ Page Title="LNM0014L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0014SprateList.aspx.vb" Inherits="JOTWEB_LNG.LNM0014SprateList" %>
...
<asp:Content ID="LNM0014LH" ContentPlaceHolderID="head" runat="server">
    <meta charset="UTF-8"/>
    ...
    <link href='<%=ResolveUrl("~/LNG/css/LNM0014L.css")%>' rel="stylesheet" type="text/css" />
    <script src="https://cdn.jsdelivr.net/npm/flatpickr@latest/dist/plugins/monthSelect/index.js"></script>
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0014L.js")%>'></script>
...
<asp:Content ID="LNM0014L" ContentPlaceHolderID="contents1" runat="server">
