...
''' </summary>
''' <remarks></remarks>
Public Class LNM0008Rect2mSearch
    Inherits Page
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = LNM0008WRKINC.MAPIDS
    ...
    Protected Sub WW_MAPValueSet()
        ...
        ElseIf Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.LNM0008L Then
            ' 実行画面からの遷移
        ...
        '○ RightBox情報設定
        rightview.MAPIDS = LNM0008WRKINC.MAPIDS
        rightview.MAPID = LNM0008WRKINC.MAPIDL
    ...
    Protected Sub WF_ButtonEND_Click()
        ...
        '○ メニュー画面遷移
        Master.TransitionPrevPage(, LNM0008WRKINC.TITLEKBNS)
