<%@ Page Title="LNM0002L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0002ReconmList.aspx.vb" Inherits="JOTWEB_LNG.LNM0002ReconmList" %>
...
<asp:Content ID="LNM0002LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0002L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0002L.js")%>'></script>
...
<asp:Content ID="LNM0002L" ContentPlaceHolderID="contents1" runat="server">
