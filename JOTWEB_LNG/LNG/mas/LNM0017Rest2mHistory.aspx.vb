...
''' </summary>
''' <remarks></remarks>
Public Class LNM0017Rest2mHistory
    Inherits Page
    ...
    Protected Sub MAPDataGet(ByVal SQLcon As MySqlConnection)
        ...
        SQLStr.AppendLine("     LNG.LNT0096_REST2HIST                                                                                     ")
        ...
        Catch ex As Exception
            Master.Output(C_MESSAGE_NO.DB_ERROR, C_MESSAGE_TYPE.ABORT, "LNM0017H SELECT")

            CS0011LOGWrite.INFSUBCLASS = "MAIN"                         'SUBクラス名
            CS0011LOGWrite.INFPOSI = "DB:LNM0017H Select"
    ...
    Protected Sub MODIFYYMGet(ByVal SQLcon As MySqlConnection)
        ...
        SQLStr.AppendLine(" FROM lng.LNT0096_REST2HIST ")
        ...
        Try
            ...
            End Using
        Catch ex As Exception
            Master.Output(C_MESSAGE_NO.DB_ERROR, C_MESSAGE_TYPE.ABORT, "LNT0096_REST2HIST SELECT")

            CS0011LOGWrite.INFSUBCLASS = "MAIN"                         'SUBクラス名
            CS0011LOGWrite.INFPOSI = "DB:LNT0096_REST2HIST Select"
            CS0011LOGWrite.NIWEA = C_MESSAGE_TYPE.ABORT
            CS0011LOGWrite.TEXT = ex.ToString()
            CS0011LOGWrite.MESSAGENO = C_MESSAGE_NO.DB_ERROR
            CS0011LOGWrite.CS0011LOGWrite()                             'ログ出力
...
#Region "ﾀﾞｳﾝﾛｰﾄﾞ"
    ...
    Protected Sub WF_EXCELPDF(ByVal WW_FILETYPE As Integer)
        ...
        '最大列(RANGE)を取得
        Dim WW_MAXCOL As Integer = [Enum].GetValues(GetType(LNM0017WRKINC.HISTORYEXCELCOL)).Cast(Of Integer)().Max()
        ...
        wb.ActiveSheet.Range("C1").Value = "使用料特例２変更履歴一覧"
    ...
    Public Sub SetHEADER(ByVal sheet As IWorksheet, ByVal WW_MAXCOL As Integer)
        ...
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.ORGCODE).Value = "組織コード"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.BIGCTNCD).Value = "大分類コード"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.MIDDLECTNCD).Value = "中分類コード"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.PURPOSE).Value = "使用目的"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRUSEFEE).Value = "特例置換項目-使用料金額"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRUSEFEERATE).Value = "特例置換項目-使用料率"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRUSEFEERATEROUND).Value = "特例置換項目-使用料率端数整理"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRUSEFEERATEADDSUB).Value = "特例置換項目-使用料率加減額"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRUSEFEERATEADDSUBCOND).Value = "特例置換項目-使用料率加減額端数整理"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRROUNDPOINTKBN).Value = "特例置換項目-端数処理時点区分"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRUSEFREESPE).Value = "特例置換項目-使用料無料特認"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRNITTSUFREESENDFEE).Value = "特例置換項目-通運負担回送運賃"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRMANAGEFEE).Value = "特例置換項目-運行管理料"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRSHIPBURDENFEE).Value = "特例置換項目-荷主負担運賃"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRSHIPFEE).Value = "特例置換項目-発送料"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRARRIVEFEE).Value = "特例置換項目-到着料"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRPICKUPFEE).Value = "特例置換項目-集荷料"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRDELIVERYFEE).Value = "特例置換項目-配達料"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPROTHER1).Value = "特例置換項目-その他１"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPROTHER2).Value = "特例置換項目-その他２"
        sheet.Cells(WW_HEADERROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRFITKBN).Value = "特例置換項目-適合区分"
    ...
    Public Sub SetDETAIL(ByVal sheet As IWorksheet, ByRef WW_ACTIVEROW As Integer)
        ...
        For Each Row As DataRow In LNM0017tbl.Rows
            ...
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.ORGCODE).Value = Row("ORGCODE") '組織コード
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.BIGCTNCD).Value = Row("BIGCTNCD") '大分類コード
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.MIDDLECTNCD).Value = Row("MIDDLECTNCD") '中分類コード
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.PURPOSE).Value = Row("PURPOSE") '使用目的
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRUSEFEE).Value = Row("SPRUSEFEE") '特例置換項目-使用料金額
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRUSEFEERATE).Value = Row("SPRUSEFEERATE") '特例置換項目-使用料率
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRUSEFEERATEROUND).Value = Row("SPRUSEFEERATEROUND") '特例置換項目-使用料率端数整理
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRUSEFEERATEADDSUB).Value = Row("SPRUSEFEERATEADDSUB") '特例置換項目-使用料率加減額
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRUSEFEERATEADDSUBCOND).Value = Row("SPRUSEFEERATEADDSUBCOND") '特例置換項目-使用料率加減額端数整理
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRROUNDPOINTKBN).Value = Row("SPRROUNDPOINTKBN") '特例置換項目-端数処理時点区分
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRUSEFREESPE).Value = Row("SPRUSEFREESPE") '特例置換項目-使用料無料特認
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRNITTSUFREESENDFEE).Value = Row("SPRNITTSUFREESENDFEE") '特例置換項目-通運負担回送運賃
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRMANAGEFEE).Value = Row("SPRMANAGEFEE") '特例置換項目-運行管理料
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRSHIPBURDENFEE).Value = Row("SPRSHIPBURDENFEE") '特例置換項目-荷主負担運賃
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRSHIPFEE).Value = Row("SPRSHIPFEE") '特例置換項目-発送料
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRARRIVEFEE).Value = Row("SPRARRIVEFEE") '特例置換項目-到着料
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRPICKUPFEE).Value = Row("SPRPICKUPFEE") '特例置換項目-集荷料
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRDELIVERYFEE).Value = Row("SPRDELIVERYFEE") '特例置換項目-配達料
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPROTHER1).Value = Row("SPROTHER1") '特例置換項目-その他１
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPROTHER2).Value = Row("SPROTHER2") '特例置換項目-その他２
            sheet.Cells(WW_ACTIVEROW, LNM0017WRKINC.HISTORYEXCELCOL.SPRFITKBN).Value = Row("SPRFITKBN") '特例置換項目-適合区分
    ...
    Public Sub SetMODIFYHATCHING(ByVal sheet As IWorksheet, ByRef WW_ACTIVEROW As Integer)
        ...
        '変更チェック開始列を取得
        Dim WW_STCOL As Integer = LNM0017WRKINC.HISTORYEXCELCOL.DELFLG   '削除フラグ
