...
Partial Public Class LNM0009RetinmSearch
    ...
    '''</remarks>
    Protected WithEvents TxtKiro As Global.System.Web.UI.WebControls.TextBox
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents DLISTKiro As Global.System.Web.UI.HtmlControls.HtmlGenericControl
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents work As Global.JOTWEB_LNG.LNM0009WRKINC
