...
Public Class LNM0017HolidayRateList
    ...
    Protected Sub MAPDataGet(ByVal SQLcon As MySqlConnection)
        ...
        SQLStr.AppendLine("   , COALESCE(RTRIM(LNM17.TANKA),'')                                          AS TANKA               ")
...
#Region "ﾀﾞｳﾝﾛｰﾄﾞ"
    ...
    Public Sub SetREQUNNECEHATCHING(ByVal sheet As IWorksheet)
        ...
        sheet.Columns(LNM0017WRKINC.INOUTEXCELCOL.TORINAME).Interior.Color = ColorTranslator.FromHtml(CONST_COLOR_HATCHING_UNNECESSARY) '取引先名
