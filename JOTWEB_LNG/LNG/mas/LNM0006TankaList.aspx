...
<asp:Content ID="LNM0006L" ContentPlaceHolderID="contents1" runat="server">
            ...
            <div class="w-100 contents">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">単価マスタ</li>
                    </ol>
                </nav>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="divItem">
                                            ...
                                            <a class="divDdlAreaLeft">
                                                <asp:ListBox ID="WF_TODOKE" runat="server" ClientIDMode="Predictable" CssClass="ddlSelectControl" SelectionMode="Multiple"></asp:ListBox>
                                            </a>
                                        </div>
                                    </div>
    ...
    <div style="display:none;">
        ...
        <input id="WF_TODOKEhdn" runat="server" value="" type="text" />
