<%@ Page Title="LNM0007L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0017HolidayRateList.aspx.vb" Inherits="JOTWEB_LNG.LNM0017HolidayRateList" %>
            ...
            <div class="w-100 contents">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">休日割増単価マスタ</li>
                    </ol>
                </nav>
                <div id="contentsInner" class="border bg-white px-3 py-3 overflow-hidden contents-inner">
                    <h2 class="w-100 fs-5 fw-bold contents-title">休日割増単価マスタ一覧</h2>
                        <div class="Operation">
