<%@ Page Title="LNM0020L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0020DieselPriceSiteList.aspx.vb" Inherits="JOTWEB_LNG.LNM0020DieselPriceSiteList" %>
...
<asp:Content ID="LNM0020LH" ContentPlaceHolderID="head" runat="server">
    <meta charset="UTF-8"/>
    ...
    <link href='<%=ResolveUrl("~/LNG/css/LNM0020L.css")%>' rel="stylesheet" type="text/css" />
    <script src="https://cdn.jsdelivr.net/npm/flatpickr@latest/dist/plugins/monthSelect/index.js"></script>
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0020L.js")%>'></script>
...
<asp:Content ID="LNM0020L" ContentPlaceHolderID="contents1" runat="server">
            ...
            <div class="w-100 contents">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">軽油価格参照先マスタ</li>
                    </ol>
                </nav>
                <div id="contentsInner" class="border bg-white px-3 py-3 overflow-hidden contents-inner">
                    <h2 class="w-100 fs-5 fw-bold contents-title">軽油価格参照先マスタ一覧</h2>
                        <div class="Operation">
