<%@ Page Title="LNM0010H" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0010SprateHistory.aspx.vb" Inherits="JOTWEB_LNG.LNM0010SprateHistory" %>
...
<asp:Content ID="LNM0010HH" ContentPlaceHolderID="head" runat="server">
    <meta charset="UTF-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css"/>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr@4.6.13/dist/flatpickr.min.css"/>
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined" />
    <link href='<%=ResolveUrl("~/LNG/css/LNM0010H.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0010H.js")%>'></script>
...
<asp:Content ID="LNM0010H" ContentPlaceHolderID="contents1" runat="server">
            ...
            <div class="w-100 contents">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a style="cursor: pointer;text-decoration:underline" onclick="ButtonClick('LNM0010L');">特別料金マスタ（一覧）</a></li>
                        <li class="breadcrumb-item active" aria-current="page">特別料金マスタ（変更履歴）</li>
                    </ol>
                </nav>
            <div id="contentsInner" class="border bg-white px-3 py-3 overflow-hidden contents-inner">
                <h2 class="w-100 fs-5 fw-bold contents-title">特別料金マスタ変更履歴</h2>
                    <div class="Operation">
