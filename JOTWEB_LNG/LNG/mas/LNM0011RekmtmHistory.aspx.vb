...
''' </summary>
''' <remarks></remarks>
Public Class LNM0011RekmtmHistory
    Inherits Page
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = LNM0011WRKINC.MAPIDH
        '○ HELP表示有無設定
    ...
    Protected Sub MAPDataGet(ByVal SQLcon As MySqlConnection)
        ...
        SQLStr.AppendLine("   , coalesce(FORMAT(FROMYMD, 'yyyy/MM/dd'), '')                                    AS FROMYMD                  ")
        ...
        SQLStr.AppendLine("     LNG.LNT0098_REKMTHIST                                                                                     ")
        ...
        Catch ex As Exception
            Master.Output(C_MESSAGE_NO.DB_ERROR, C_MESSAGE_TYPE.ABORT, "LNM0011H SELECT")

            CS0011LOGWrite.INFSUBCLASS = "MAIN"                         'SUBクラス名
            CS0011LOGWrite.INFPOSI = "DB:LNM0011H Select"
    ...
    Protected Sub MODIFYYMGet(ByVal SQLcon As MySqlConnection)
        ...
        SQLStr.AppendLine(" FROM lng.LNT0098_REKMTHIST ")
        ...
        Try
            ...
            End Using
        Catch ex As Exception
            Master.Output(C_MESSAGE_NO.DB_ERROR, C_MESSAGE_TYPE.ABORT, "LNT0098_REKMTHIST SELECT")

            CS0011LOGWrite.INFSUBCLASS = "MAIN"                         'SUBクラス名
            CS0011LOGWrite.INFPOSI = "DB:LNT0098_REKMTHIST Select"
            CS0011LOGWrite.NIWEA = C_MESSAGE_TYPE.ABORT
            CS0011LOGWrite.TEXT = ex.ToString()
            CS0011LOGWrite.MESSAGENO = C_MESSAGE_NO.DB_ERROR
            CS0011LOGWrite.CS0011LOGWrite()                             'ログ出力
...
#Region "ﾀﾞｳﾝﾛｰﾄﾞ"
    ...
    Protected Sub WF_EXCELPDF(ByVal WW_FILETYPE As Integer)
        ...
        '最大列(RANGE)を取得
        Dim WW_MAXCOL As Integer = [Enum].GetValues(GetType(LNM0011WRKINC.HISTORYEXCELCOL)).Cast(Of Integer)().Max()
        ...
        wb.ActiveSheet.Range("C1").Value = "キロ程変更履歴一覧"
    ...
    Public Sub SetHEADER(ByVal sheet As IWorksheet, ByVal WW_MAXCOL As Integer)
        ...
        sheet.Cells(WW_HEADERROW, LNM0011WRKINC.HISTORYEXCELCOL.OPERATEKBNNAME).Value = "操作区分"
        sheet.Cells(WW_HEADERROW, LNM0011WRKINC.HISTORYEXCELCOL.MODIFYKBNNAME).Value = "変更区分"
        sheet.Cells(WW_HEADERROW, LNM0011WRKINC.HISTORYEXCELCOL.MODIFYYMD).Value = "変更日時"
        sheet.Cells(WW_HEADERROW, LNM0011WRKINC.HISTORYEXCELCOL.MODIFYUSER).Value = "変更USER"
        sheet.Cells(WW_HEADERROW, LNM0011WRKINC.HISTORYEXCELCOL.DELFLG).Value = "削除フラグ"
        sheet.Cells(WW_HEADERROW, LNM0011WRKINC.HISTORYEXCELCOL.DEPSTATION).Value = "発駅コード"
        sheet.Cells(WW_HEADERROW, LNM0011WRKINC.HISTORYEXCELCOL.ARRSTATION).Value = "着駅コード"
        sheet.Cells(WW_HEADERROW, LNM0011WRKINC.HISTORYEXCELCOL.FROMYMD).Value = "摘要年月日"
        sheet.Cells(WW_HEADERROW, LNM0011WRKINC.HISTORYEXCELCOL.KIRO).Value = "キロ程"
    ...
    Public Sub SetDETAIL(ByVal sheet As IWorksheet, ByRef WW_ACTIVEROW As Integer)
        ...
        For Each Row As DataRow In LNM0011tbl.Rows
            '値
            sheet.Cells(WW_ACTIVEROW, LNM0011WRKINC.HISTORYEXCELCOL.OPERATEKBNNAME).Value = Row("OPERATEKBNNAME") '操作区分
            sheet.Cells(WW_ACTIVEROW, LNM0011WRKINC.HISTORYEXCELCOL.MODIFYKBNNAME).Value = Row("MODIFYKBNNAME") '変更区分
            sheet.Cells(WW_ACTIVEROW, LNM0011WRKINC.HISTORYEXCELCOL.MODIFYYMD).Value = Row("MODIFYYMD") '変更日時
            sheet.Cells(WW_ACTIVEROW, LNM0011WRKINC.HISTORYEXCELCOL.MODIFYUSER).Value = Row("MODIFYUSER") '変更USER
            sheet.Cells(WW_ACTIVEROW, LNM0011WRKINC.HISTORYEXCELCOL.DELFLG).Value = Row("DELFLG") '削除フラグ
            sheet.Cells(WW_ACTIVEROW, LNM0011WRKINC.HISTORYEXCELCOL.DEPSTATION).Value = Row("DEPSTATION") '発駅コード
            sheet.Cells(WW_ACTIVEROW, LNM0011WRKINC.HISTORYEXCELCOL.ARRSTATION).Value = Row("ARRSTATION") '着駅コード
            sheet.Cells(WW_ACTIVEROW, LNM0011WRKINC.HISTORYEXCELCOL.FROMYMD).Value = Row("FROMYMD") '摘要年月日
            sheet.Cells(WW_ACTIVEROW, LNM0011WRKINC.HISTORYEXCELCOL.KIRO).Value = Row("KIRO") 'キロ程

            '変更区分が変更後の行の場合
            If Row("MODIFYKBN") = LNM0011WRKINC.MODIFYKBN.AFTDATA Then
                '変更箇所を塗りつぶし
    ...
    Public Sub SetMODIFYHATCHING(ByVal sheet As IWorksheet, ByRef WW_ACTIVEROW As Integer)
        ...
        '変更チェック開始列を取得
        Dim WW_STCOL As Integer = LNM0011WRKINC.HISTORYEXCELCOL.DELFLG   '削除フラグ
