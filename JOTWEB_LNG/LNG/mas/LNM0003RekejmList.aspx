<%@ Page Title="LNM0003L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0003RekejmList.aspx.vb" Inherits="JOTWEB_LNG.LNM0003RekejmList" %>
...
<asp:Content ID="LNM0003LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0003L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0003L.js")%>'></script>
...
<asp:Content ID="LNM0003L" ContentPlaceHolderID="contents1" runat="server">
