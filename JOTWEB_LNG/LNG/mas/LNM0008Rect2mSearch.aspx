<%@ Page Title="LNM0008S" Language="vb" AutoEventWireup="false" CodeBehind="LNM0008Rect2mSearch.aspx.vb" Inherits="JOTWEB_LNG.LNM0008Rect2mSearch" %>
...
<asp:Content id="LNM0008SH" contentplaceholderid="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0008S.css")%>' rel="stylesheet" type="text/css" />
</asp:Content>

<asp:Content ID="LNM0008S" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　searchbox -->
