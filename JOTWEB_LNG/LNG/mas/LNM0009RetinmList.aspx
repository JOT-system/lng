<%@ Page Title="LNM0009L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0009RetinmList.aspx.vb" Inherits="JOTWEB_LNG.LNM0009RetinmList" %>
...
<asp:Content ID="LNM0009LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0009L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0009L.js")%>'></script>
...
<asp:Content ID="LNM0009L" ContentPlaceHolderID="contents1" runat="server">
