...
Partial Public Class LNM0023ShipperSearch
    ...
    '''</remarks>
    Protected WithEvents TxtShipperCd As Global.System.Web.UI.WebControls.TextBox
    
    '''<summary>
    '''LblShipperCdName コントロール。
    '''</summary>
    '''<remarks>
    '''自動生成されたフィールド。
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents LblShipperCdName As Global.System.Web.UI.WebControls.Label
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents work As Global.JOTWEB_LNG.LNM0023WRKINC
