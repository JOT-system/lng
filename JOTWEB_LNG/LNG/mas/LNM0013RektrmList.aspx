<%@ Page Title="LNM0013L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0013RektrmList.aspx.vb" Inherits="JOTWEB_LNG.LNM0013RektrmList" %>
...
<asp:Content ID="LNM0013LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0013L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0013L.js")%>'></script>
...
<asp:Content ID="LNM0013L" ContentPlaceHolderID="contents1" runat="server">
