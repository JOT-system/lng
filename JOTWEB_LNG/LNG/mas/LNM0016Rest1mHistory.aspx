<%@ Page Title="LNM0016H" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0016Rest1mHistory.aspx.vb" Inherits="JOTWEB_LNG.LNM0016Rest1mHistory" %>
...
<asp:Content ID="LNM0016HH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0016H.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0016H.js")%>'></script>
...
<asp:Content ID="LNM0016H" ContentPlaceHolderID="contents1" runat="server">
