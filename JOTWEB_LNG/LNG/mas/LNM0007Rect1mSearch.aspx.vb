...
''' </summary>
''' <remarks></remarks>
Public Class LNM0007Rect1mSearch
    Inherits Page
    ...
    Protected Sub Initialize()
        ...
        '○ 画面ID設定
        Master.MAPID = LNM0007WRKINC.MAPIDS
    ...
    Protected Sub WW_MAPValueSet()
        ...
        ElseIf Context.Handler.ToString().ToUpper() = C_PREV_MAP_LIST.LNM0007L Then
            ' 実行画面からの遷移
        ...
        '○ RightBox情報設定
        rightview.MAPIDS = LNM0007WRKINC.MAPIDS
        rightview.MAPID = LNM0007WRKINC.MAPIDL
    ...
    Protected Sub WW_Check(ByRef O_RTN As String)
        ...
        If isNormal(WW_CS0024FCheckerr) Then
            If Not String.IsNullOrEmpty(TxtDepTrusteeCd.Text) Then
                ...
                If Not isNormal(WW_RtnSW) Then
                    Master.Output(C_MESSAGE_NO.NO_DATA_EXISTS_ERROR, C_MESSAGE_TYPE.ERR, "発受託人コード : " & LblDepTrusteeCdName.Text, needsPopUp:=True)
                    LblDepTrusteeCdName.Focus()
                    O_RTN = "ERR"
                    Exit Sub
                End If
            End If
    ...
    Protected Sub WF_ButtonEND_Click()
        ...
        '○ メニュー画面遷移
        Master.TransitionPrevPage(, LNM0007WRKINC.TITLEKBNS)
