<%@ Page Title="LNM0009H" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0009RetinmHistory.aspx.vb" Inherits="JOTWEB_LNG.LNM0009RetinmHistory" %>
...
<asp:Content ID="LNM0009HH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0009H.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0009H.js")%>'></script>
...
<asp:Content ID="LNM0009H" ContentPlaceHolderID="contents1" runat="server">
