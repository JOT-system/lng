<%@ Page Title="LNM0024L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0024KekkjmList.aspx.vb" Inherits="JOTWEB_LNG.LNM0024KekkjmList" %>
...
<asp:Content ID="LNM0026LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0024L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0024L.js")%>'></script>
