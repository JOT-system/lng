<%@ Page Title="LNM0024H" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0024KekkjmHistory.aspx.vb" Inherits="JOTWEB_LNG.LNM0024KekkjmHistory" %>
...
<asp:Content ID="LNM0026LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0024H.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0024H.js")%>'></script>
