<%@ Page Title="LNM0011L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0011RekmtmList.aspx.vb" Inherits="JOTWEB_LNG.LNM0011RekmtmList" %>
...
<asp:Content ID="LNM0011LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0011L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0011L.js")%>'></script>
...
<asp:Content ID="LNM0011L" ContentPlaceHolderID="contents1" runat="server">
