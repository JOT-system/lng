<%@ Page Title="LNM0003H" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0003RekejmHistory.aspx.vb" Inherits="JOTWEB_LNG.LNM0003RekejmHistory" %>
...
<asp:Content ID="LNM0003HH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0003H.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0003H.js")%>'></script>
...
<asp:Content ID="LNM0003H" ContentPlaceHolderID="contents1" runat="server">
