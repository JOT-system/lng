<%@ Page Title="LNM0008H" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0008Rect2mHistory.aspx.vb" Inherits="JOTWEB_LNG.LNM0008Rect2mHistory" %>
...
<asp:Content ID="LNM0008HH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0008H.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0008H.js")%>'></script>
...
<asp:Content ID="LNM0008H" ContentPlaceHolderID="contents1" runat="server">
