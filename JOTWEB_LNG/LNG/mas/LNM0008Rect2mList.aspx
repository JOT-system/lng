<%@ Page Title="LNM0008L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0008Rect2mList.aspx.vb" Inherits="JOTWEB_LNG.LNM0008Rect2mList" %>
...
<asp:Content ID="LNM0008LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0008L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0008L.js")%>'></script>
...
<asp:Content ID="LNM0008L" ContentPlaceHolderID="contents1" runat="server">
