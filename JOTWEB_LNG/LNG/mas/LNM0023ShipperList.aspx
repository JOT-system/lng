<%@ Page Title="LNM0023L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0023ShipperList.aspx.vb" Inherits="JOTWEB_LNG.LNM0023ShipperList" %>
...
<asp:Content ID="LNM0023LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0023L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0023L.js")%>'></script>
...
<asp:Content ID="LNM0023L" ContentPlaceHolderID="contents1" runat="server">
