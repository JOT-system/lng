<%@ Page Title="LNM0021L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0021ItemList.aspx.vb" Inherits="JOTWEB_LNG.LNM0021ItemList" %>
...
<asp:Content ID="LNM0021LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0021L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0021L.js")%>'></script>
...
<asp:Content ID="LNM0021L" ContentPlaceHolderID="contents1" runat="server">
