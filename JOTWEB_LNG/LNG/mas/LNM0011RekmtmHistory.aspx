<%@ Page Title="LNM0011H" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0011RekmtmHistory.aspx.vb" Inherits="JOTWEB_LNG.LNM0011RekmtmHistory" %>
...
<asp:Content ID="LNM0011HH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0011H.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0011H.js")%>'></script>
...
<asp:Content ID="LNM0011H" ContentPlaceHolderID="contents1" runat="server">
