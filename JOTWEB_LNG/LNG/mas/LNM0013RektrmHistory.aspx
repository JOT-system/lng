<%@ Page Title="LNM0013H" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0013RektrmHistory.aspx.vb" Inherits="JOTWEB_LNG.LNM0013RektrmHistory" %>
...
<asp:Content ID="LNM0013HH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0013H.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0013H.js")%>'></script>
...
<asp:Content ID="LNM0013H" ContentPlaceHolderID="contents1" runat="server">
