<%@ Page Title="LNM0016S" Language="vb" AutoEventWireup="false" CodeBehind="LNM0016Rest1mSearch.aspx.vb" Inherits="JOTWEB_LNG.LNM0016Rest1mSearch" %>
...
<asp:Content id="LNM0016SH" contentplaceholderid="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0016S.css")%>' rel="stylesheet" type="text/css" />
</asp:Content>

<asp:Content ID="LNM0016S" ContentPlaceHolderID="contents1" runat="server">
    <!-- 全体レイアウト　searchbox -->
        ...
        <div class="inputBox">
            ...
            <div class="inputItem">
                ...
                <a class="ef" id="WF_DEPTRUSTEESUBCD" ondblclick="Field_DBclick('TxtDepTrusteeSubCd', <%=LIST_BOX_CLASSIFICATION.LC_REKEJM%>);" onchange="TextBox_change('TxtDepTrusteeSubCd');">
                    <asp:TextBox ID="TxtDepTrusteeSubCd" runat="server" CssClass="WF_TEXTBOX_CSS boxIcon"  onblur="MsgClear();" MaxLength="5"></asp:TextBox>
                </a>
