<%@ Page Title="LNM0015L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0015ResrtmList.aspx.vb" Inherits="JOTWEB_LNG.LNM0015ResrtmList" %>
...
<asp:Content ID="LNM0015LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0015L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0015L.js")%>'></script>
...
<asp:Content ID="LNM0015L" ContentPlaceHolderID="contents1" runat="server">
