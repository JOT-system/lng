<%@ Page Title="LNM0017L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0017Rest2mList.aspx.vb" Inherits="JOTWEB_LNG.LNM0017Rest2mList" %>
...
<asp:Content ID="LNM0017LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0017L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0017L.js")%>'></script>
...
<asp:Content ID="LNM0017L" ContentPlaceHolderID="contents1" runat="server">
