<%@ Page Title="LNM0002H" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0002ReconmHistory.aspx.vb" Inherits="JOTWEB_LNG.LNM0002ReconmHistory" %>
...
<asp:Content ID="LNM0002HH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0002H.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0002H.js")%>'></script>
...
<asp:Content ID="LNM0002H" ContentPlaceHolderID="contents1" runat="server">
