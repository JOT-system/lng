<%@ Page Title="LNM0026L" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNM0026IncentiveList.aspx.vb" Inherits="JOTWEB_LNG.LNM0026IncentiveList" %>
...
<asp:Content ID="LNM0026LH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNM0026L.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNM0026L.js")%>'></script>
...
<asp:Content ID="LNM0026L" ContentPlaceHolderID="contents1" runat="server">
