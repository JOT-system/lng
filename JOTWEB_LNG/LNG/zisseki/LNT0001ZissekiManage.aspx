<%@ Page Title="LNT0001C" Language="vb" AutoEventWireup="false" MasterPageFile="~/LNG/LNGMasterPage.Master" CodeBehind="LNT0001ZissekiManage.aspx.vb" Inherits="JOTWEB_LNG.LNT0001ZissekiManage" %>
...
<asp:Content ID="LNT0001CH" ContentPlaceHolderID="head" runat="server">
    <link href='<%=ResolveUrl("~/LNG/css/LNT0001C.css")%>' rel="stylesheet" type="text/css" />
    <script type="text/javascript" src='<%=ResolveUrl("~/script/fixed_midashi.js")%>'></script>
    <script type="text/javascript" src='<%=ResolveUrl("~/LNG/script/LNT0001C.js")%>'></script>
...
<asp:Content ID="LNT0001C" ContentPlaceHolderID="contents1" runat="server">
    ...
    <div class="headerbox" id="headerbox">
        <div class="actionButtonBox">
            ...
            <div class="rightSide">
                <input type="button" id="WF_ButtonKintone" class="btn-sticky" value="実績取込（アボカド）" onclick="ButtonClick('WF_ButtonKintone');" />
                <input type="button" id="WF_ButtonPrint" class="btn-sticky" value="帳票出力" onclick="return false;" disabled="disabled" />
    ...
    <div class="detailbox" id="detailbox">
        ...
        <div class="tblWrapper">
            <asp:GridView ID="gvLNT0001" runat="server" CssClass="tbl ctnlist" _fixedhead="rows:1; cols:7; div-auto-size: none;"
                ...
                OnPreRender="gvLNT0001_PreRender" OnDataBound="gvLNT0001_DataBound">
                <Columns> 
                    <asp:TemplateField>
