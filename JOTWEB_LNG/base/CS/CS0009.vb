    ...
    Public Sub CS0009MESSAGEout()
        ...
        Try
            ...
            Dim SQLStr As String =
                 "SELECT rtrim(MSGNAIYOU) as MSGNAIYOU " _
               & " FROM  COM.LNS0015_MESSAGE " _
               & " Where MSGID= @P1 "
            'DataBase接続文字
            Using SQLcon = sm.getConnection,
                ...
                SQLcmd.Parameters.Add("@P1", MySqlDbType.VarChar, 10).Value = MESSAGENO
                Using SQLdr As MySqlDataReader = SQLcmd.ExecuteReader()
                    While SQLdr.Read
                        W_Message = "  " & Convert.ToString(SQLdr("MSGNAIYOU"))
                        ...
                        W_Message = W_Message.Replace("?br", vbCrLf)
        ...
        Catch ex As Exception
            ...
            CS0011LOGWRITE.INFSUBCLASS = METHOD_NAME             'SUBクラス名
            CS0011LOGWRITE.INFPOSI = "DB:LNS0015_MESSAGE Select " & MESSAGENO        '
            CS0011LOGWRITE.NIWEA = C_MESSAGE_TYPE.ABORT                                   '
            CS0011LOGWRITE.TEXT = ex.ToString()
            CS0011LOGWRITE.MESSAGENO = C_MESSAGE_NO.DB_ERROR
            CS0011LOGWRITE.CS0011LOGWrite()                             'ログ出力

            MESSAGEBOX.Text = "システム管理者へ連絡して下さい(DB LNS0015_MESSAGE Select ERR)" & "NO:" & MESSAGENO
            MESSAGEBOX.ForeColor = Drawing.Color.Red 'red
