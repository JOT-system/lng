...
Public Structure CS0021PROFXLS
    ...
    ''' <remarks></remarks>
    Private Sub GetProfM(ByVal SQLcon As MySqlConnection)
        ...
        Try
            Using SQLcmd As New MySqlCommand(SQLstr, SQLcon)
                With SQLcmd.Parameters
                    ...
                    .Add("@P4", MySqlDbType.VarChar, 50).Value = REPORTID
        ...
        Catch ex As Exception
            ...
            Dim CS0011LOGWrite As New CS0011LOGWrite
            CS0011LOGWrite.INFSUBCLASS = METHOD_NAME                    'SUBクラス名
            CS0011LOGWrite.INFPOSI = "DB:LNS0012_PROFMXLS Select"         '問題発生個所
