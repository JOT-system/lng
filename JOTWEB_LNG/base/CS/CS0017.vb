...
Public Structure CS0017ForwardURL
    ...
    Public Sub getPreviusURL()
        ...
        '●画面戻先URL取得
        '○ DB(LNS0009_PROFMMAP-LNS0007_URL)検索
        ...
        Try
            ...
            Dim SQLStr As String =
                   ...
                   & " INNER JOIN COM.LNS0007_URL B " _
            ...
            End If
            If Not String.IsNullOrEmpty(TITLEKBN) Then
                SQLStr += "   and A.TITLEKBN IN('I', @P7) "
            Else
                SQLStr += "   and A.TITLEKBN = 'I' "
            End If
            ...
            Using SQLcon = sm.getConnection,
                ...
                With SQLcmd.Parameters
                    .Add("@P1", MySqlDbType.VarChar, 50).Value = MAPID
                    .Add("@P2", MySqlDbType.VarChar, 50).Value = VARI
                    ...
                    If Not String.IsNullOrEmpty(CAMPCODE) Then
                        .Add("@P6", MySqlDbType.VarChar, 50).Value = CAMPCODE
                    End If
                    If Not String.IsNullOrEmpty(TITLEKBN) Then
                        .Add("@P7", MySqlDbType.VarChar, 1).Value = TITLEKBN
                    End If
                End With
        ...
        Catch ex As Exception
            ...
            CS0011LOGWRITE.INFPOSI = "LNS0009_PROFMMAP SELECT (" & MAPID & " " & VARI & ")"
            CS0011LOGWRITE.NIWEA = C_MESSAGE_TYPE.ABORT
    ...
    Public Sub getNextURL()
        ...
        Catch ex As Exception
            ...
            CS0011LOGWRITE.INFSUBCLASS = METHOD_NAME
            CS0011LOGWRITE.INFPOSI = "LNS0009_PROFMMAP SELECT"
            CS0011LOGWRITE.NIWEA = C_MESSAGE_TYPE.ABORT
            CS0011LOGWRITE.TEXT = ex.ToString()
            CS0011LOGWRITE.MESSAGENO = C_MESSAGE_NO.DB_ERROR
            CS0011LOGWRITE.CS0011LOGWrite()
