...
''' </summary>
''' <remarks></remarks>
Public Class GL0024ShipperList
    Inherits GL0000
    ...
    ''' 荷主マスタ一覧取得
    ''' </summary>
    Protected Sub getShipperList(ByVal SQLcon As MySqlConnection)
        '●Leftボックス用発受託人コード取得
        ...
        Try
            ...
            SQLStr = " SELECT DISTINCT                   " _
                   & "     RTRIM(A.SHIPPERCD) AS CODE  , " _
                   & "     RTRIM(A.NAME)      AS NAMES , " _
                   & "     ''                 AS SEQ     " _
                   & " FROM    LNG.LNM0023_SHIPPER A     " _
                   & " WHERE                             " _
                   & "         A.DELFLG   <> @P0         " _
                   & " ORDER BY CODE                     "
        ...
        Catch ex As Exception
            ...
            CS0011LOGWRITE.INFSUBCLASS = "GL0024"                       'SUBクラス名
