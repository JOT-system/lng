...
Public Class GL0012RoleList
    ...
    ''' ロール一覧取得
    ''' </summary>
    Protected Sub getRoleList(ByVal SQLcon As MySqlConnection)
        '●Leftボックス用会社取得
        ...
        Try
            ...
            Using SQLcmd As New MySqlCommand(SQLStr, SQLcon)
                With SQLcmd.Parameters
                    ...
                    .Add("@P4", MySqlDbType.VarChar, 20).Value = OBJCODE
                    .Add("@P5", MySqlDbType.VarChar, 20).Value = C_DELETE_FLG.DELETE
                End With
