...
Public MustInherit Class GL0000 : Implements IDisposable
    ...
    ''' <remarks></remarks>
    Protected Sub addListData(ByVal I_SQLDR As MySqlDataReader)
    ...
    ''' <remarks></remarks>
    Protected Sub addListData(ByVal I_SQLDR As MySqlDataReader, ByVal CODE_NAME As String, ByVal NAMES_NAME As String)
        While I_SQLDR.Read
    ...
    ''' <param name="I_SQLDR"></param>
    ''' <remarks></remarks>
    Protected Overridable Function extracheck(ByVal I_SQLDR As MySqlDataReader) As Boolean
        Return True
    End Function
    ''' <summary>
    ''' 一覧作成処理
    ...
    ''' <param name="NAMES_NAME"></param>
    ''' <remarks></remarks>
    Public Overridable Sub addExtraListData(ByVal I_SQLDR As MySqlDataReader, ByVal CODE_NAME As String, ByVal NAMES_NAME As String)
        LIST.Items.Add(New ListItem(Convert.ToString(I_SQLDR(NAMES_NAME)), Convert.ToString(I_SQLDR(CODE_NAME))))
    End Sub
