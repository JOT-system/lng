...
''' 品目別販売実績表 冷＆Ｓ呼び出し
''' </summary>
Public Class PRT0004SalesResults
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Const METHOD_NAME As String = "PRT0004SalesResults"
        ...
        Try
            If LastFLG = "1" Then
                ...
                Using SQLcon = sm.getConnection
                    ...
                    Dim Report As New LNT0012_SalesResultsReport_DIODOC("LNT0012S", "品目別販売実績表_TEMPLATE.xlsx", BEDT)
                    Try
                        WW_URL = Report.CreateExcelPrintData(OfficeCode, CDate(FROMYMD), CDate(TOYMD), "1")
