...
(function($, undefined) {
  ...
  function getjQueryFromElement(elem) {
    ...
    * @return {object} jQuery object for the DOM element to append to.
    ...
    /**
     * ConstruLNS the button element for the widget
     ...
     */
     ...
     /**
      * ConstruLNS HTML string for menu header
      * @return {string}
      */
 ...
 return $(this).next().text().replace(/\n$/, '');
    ...
    */
    ...
    /**
     * Opens the menu, possibly with effeLNS
    ...
    open: function() {
      ...
      if (!!effect) {
         // Menu must be hidden for some effeLNS (e.g. fade) to work.
    ...
    */
    ...
    /**
     * ReaLNS to options being changed
